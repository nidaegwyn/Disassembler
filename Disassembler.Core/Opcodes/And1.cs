namespace Disassembler.Core.Opcodes
{
    ...
    public class And1 : Opcode
    {
        public And1()
        {
            ...
            {
                new BytePattern(){ ByteValue = 0x20, ByteMask = 0xFC, ApplyMask = true, Variables = { new Tuple<string, int, int>("d", 6, 1), new Tuple<string, int, int>("w", 7, 1) } },
