namespace Disassembler.Core.Opcodes
{
    ...
    public class Sbb1 : Opcode
    {
        public Sbb1()
        {
            ...
            {
                new BytePattern(){ ByteValue = 0x18, ByteMask = 0xFC, ApplyMask = true, Variables = { new Tuple<string, int, int>("d", 6, 1), new Tuple<string, int, int>("w", 7, 1) } },
