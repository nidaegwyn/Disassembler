namespace Disassembler.Core.Opcodes
{
    ...
    public class Imul : Opcode
    {
        public Imul()
        {
            ...
            {
                new BytePattern(){ ByteValue = 0xF6, ByteMask = 0xFE, ApplyMask = true, Variables = { new Tuple<string, int, int>("w", 7, 1) } },
                new BytePattern(){ ByteValue = 0x28, ByteMask = 0x38, ApplyMask = true, Variables = { new Tuple<string, int, int>("mod", 0, 2), new Tuple<string, int, int>("r/m", 5, 3) } },
