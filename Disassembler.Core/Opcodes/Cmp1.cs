namespace Disassembler.Core.Opcodes
{
    ...
    public class Cmp1 : Opcode
    {
        public Cmp1()
        {
            ...
            {
                new BytePattern(){ ByteValue = 0x38, ByteMask = 0xFC, ApplyMask = true, Variables = { new Tuple<string, int, int>("d", 6, 1), new Tuple<string, int, int>("w", 7, 1) } },
