namespace Disassembler.Core.Opcodes
{
    ...
    public class Xor1 : Opcode
    {
        public Xor1()
        {
            ...
            {
                new BytePattern(){ ByteValue = 0x30, ByteMask = 0xFC, ApplyMask = true, Variables = { new Tuple<string, int, int>("d", 6, 1), new Tuple<string, int, int>("w", 7, 1) } },
