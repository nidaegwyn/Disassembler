namespace Disassembler.Core.Opcodes
{
    ...
    public class Adc1 : Opcode
    {
        public Adc1()
        {
            ...
            {
                new BytePattern(){ ByteValue = 0x10, ByteMask = 0xFC, ApplyMask = true, Variables = { new Tuple<string, int, int>("d", 6, 1), new Tuple<string, int, int>("w", 7, 1) } },
